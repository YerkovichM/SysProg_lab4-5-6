...
public class SysProgrammingMainAlgorithm {
    ...
    public static void main(String[] args) {
        ...
        String[] menu = {"*1.  Прочитати граматику з файла  ",
                ...
                "*23. Побудувати 2множини FirstK(w) для правила , A->W",
        ...
        do {
            ...
            switch (codeAction) {
                case 1: //1. Прочитати граматику з файла",
                    ...
                    testLang = new TestLang(fileName, llk);
                ...
                case 2: //2. Лабораторна робота студента
                    //testLang.removeFromGrammar(); //lab 4
                    //testLang.rightRecursNonnerminal();
                    testLang.followSearchAndSet(); // lab 5
                    break;
                ...
                case 21:  //Побудова таблиці LL(1)-синтаксичного аналізатора
                    ...
                    break;
                case 22:
                    //4 5 6 7 13 15 17 20 21
                    String path;
                    System.out.println("Enter the path to the PL0 program file:\n");
                    try (Scanner in = new Scanner(System.in)) {
                        path = in.nextLine();
                        TestPL0Parser parser = new TestPL0Parser(testLang,path);
                        parser.parse();
                    }
